...
SECONDARY_RATE_LIMIT_RETRIES = int(
    os.environ.get("GIDGETHUB_SECONDARY_RATE_LIMIT_RETRY", 3)
)
SECONDARY_RATE_LIMIT_BASE_DELAYS = int(
    os.environ.get("GIDGETHUB_SECONDARY_RATE_LIMIT_BASE_DELAY", 60)
)
